...
const profileNameInput = profileEditForm.querySelector(".modal__input-type_name");
const profileDescriptionInput = profileEditForm.querySelector(".modal__input-type_description");
